...
public class VetAppointmentController {
    ...
    public String all(@AuthenticationPrincipal Person vet, Model model) {
        ...
        model.addAttribute("appointments", appointmentService.getAppointmentsForVet(vet.getId()));
    ...
    public String pending(@AuthenticationPrincipal Person vet, Model model) {
        ...
        model.addAttribute("vet", vet);
        model.addAttribute("pendingAppointments", appointmentService.getPendingAppointmentsForVet(vet.getId()));
    ...
    public String confirmed(@AuthenticationPrincipal Person vet, Model model) {
        ...
        model.addAttribute("vet", vet);
        model.addAttribute("confirmedAppointments", appointmentService.getConfirmedAppointmentsForVet(vet.getId()));
    ...
    public String cancelled(@AuthenticationPrincipal Person vet, Model model) {
        ...
        model.addAttribute("vet", vet);
        model.addAttribute("cancelledAppointments", appointmentService.getCancelledAppointmentsForVet(vet.getId()));
    ...
    public String completed(@AuthenticationPrincipal Person vet, Model model) {
        ...
        model.addAttribute("vet", vet);
        model.addAttribute("completedAppointments", appointmentService.getCompletedAppointmentsForVet(vet.getId()));
    ...
    public String confirm(@PathVariable("id") Long appointmentId, @AuthenticationPrincipal Person vet) {
        if (vet == null) {
            throw new ResponseStatusException(HttpStatus.UNAUTHORIZED, "Not logged in");
        }
        if (vet.getRole() != Role.VET) {
